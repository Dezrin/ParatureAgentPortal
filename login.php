<?php 
    ...
    { 
        ...
        { 
            ...
            die("Redirecting to: startcall.php"); 
        } 
        else 
        { 
...
<title>Parature Agent Portal - Login</title>
...
<!-- CSS: implied media="all" -->
  ...
  <link rel="icon" type="image/jpg" href="//intycascade.com/static/images/furniture/favicon.jpg" />
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
		...
		<li><a href="CMAT.php">CMAT Notes</a></li>
		<li><a href="//inty1.sharepoint.com/sites/concierge/_layouts/15/guestaccess.aspx?guestaccesstoken=rCX9d0bYStaf0OuSBSiDEAs1ewqu%2bFcDzaCgt7javxY%3d&docid=2_1eae9aa4ce68c45949670091b881e0d47" target="_blank">Call Log</a></li>
...
<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  <center><strong>NOTICE:</strong> Welcome to Parature Agent Portal, the new version of Parature Notes System!</a></center>
</div>
<div id="page-wrap">
<div class="header">
  <h1>Parature Agent Portal - Login</h1>
</div>
<br>
...
<form action="login.php" method="post"> 
	...
	<br>
	<br>
    <button type="submit" class="btn btn-primary pull-left btn-lg" value="Login" >Login</button> 
</form> 
<br>
<br>
<hr>
<a href="resetpassword.php"><button type="button" class="btn btn-primary pull-left">Reset Password</button></a>
<br>
<br>
