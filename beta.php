...
if(isset($_POST['submit'])){
	...
	$message = '<thread>';
	$message = '<tr>';
	$message = '<th>Customers Issues</th>';
	$message = '<th>Customers Software</th>';
	$message = '<th>Customers Operating System</th>';
	$message = '<th>Ticket Notes</th>';
	$message = '<th>Next Action Plan</th>';
	$message = '<th>Current Team Leader (if escalation)</th>';
	$message = '<th>Next Team Leader (if escalation)</th>';
	$message = '<th>Customer Requests</th>';
	$message = '<th>IT Advisor Experiment</th>';
	$message = '<th>Other Details</th>';
	$message = '</tr>';
	$message = '</thread>';
	$message = '<tbody>';
	$message = '<tr>';
	$message = '<td>' . $customers_issue . '</td>';
	$message = '<td>' . $customers_software . '</td>';
	$message = '<td>' . $customers_os . '</td>';
	$message = '<td>' . $ticket_notes . $line . $ticket_notes2 . $line . $ticket_notes3 . $line . $ticket_notes4 . $line . $ticket_notes5 . $line . $ticket_notes6 . $line . $ticket_notes7 . $line . $ticket_notes8 . $line . $ticket_notes9 . $line . $ticket_notes10 . $line . $ticket_notes11 . $line . $ticket_notes12 . $line . $ticket_notes13 . $line . $ticket_notes14 . $line . $ticket_notes15 . $line . $ticket_notes16 . $line . $ticket_notes17 . $line . $ticket_notes18 . $line . $ticket_notes19 . $line . $ticket_notes20 . '</td>';
	$message = '<td>' . $action_plan . $line . $actionplan_other '</td>';
	$message = '<td>' . $team_leaders . '</td>';
	$message = '<td>' . $next_team . '</td>';
	$message = '<td>' . $customer_requests . '</td>';
	$message = '<td>' . $trial . $line . $trial1 . $line . $trial2 . $line . $trial3 . $line . $trial4 . '</td>';
	$message = '<td>' . $details . '</td>';
	$message = '</tr>';
	$message = '</tbody>';
	$message = '</table>';
	$message = "</body></html>";
...
<div id="footer">
	<p><a href="http://inty.com">intY Limited</a> &nbsp;&middot;&nbsp; Copyright &#169; 2015 Sapling Servers Limited &nbsp;&middot;&nbsp; Parature Agent Portal Version - 1.2.0</p>
</div>
	</div>
	</div>
</html>